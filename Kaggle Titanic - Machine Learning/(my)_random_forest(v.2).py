...
# Inclusions:
# A. Include cabin and name
# Improvement from 0.8103 to 0.8181
# Improvement in Kaggle from 0.74163 to 0.71770
...
write_in_file('Data/(my)_random_forest(v.2).csv', test, output)
